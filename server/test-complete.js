...
async function testAuctions() {
    ...
    assert(game.auction.currentBid === 15, 'Current bid updated');
    assert(game.auction.highestBidder === player2.id, 'Highest bidder set');
    
    // Complete auction
    game.auction.passedPlayers = game.players.map(p => p.id);
